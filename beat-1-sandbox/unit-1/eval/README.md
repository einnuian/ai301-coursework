...
refuses to grade with an empty rubric, so write your checks and verdict rule first.

Point `--skill` at your global skill folder. `run_eval.py` currently looks for local skill.
